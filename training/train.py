...
from training.config import VLAConfig, VLARegistry
...
class TrainConfig:
    ...
    vla: VLAConfig = field(
        default_factory=VLAConfig.get_choice_class(VLARegistry.EXP_CronusVLA_OXE_MAGIC_SOUP_PLUS_MINUS.vla_id)
    )
    ...
    def __post_init__(self) -> None:
        ...
        self.view_sequence_len = self.vla.view_sequence_len
...
def train(cfg: TrainConfig) -> None:
    overwatch.info("CronusVLA-VLA Training :: Warming Up")
    ...
    if cfg.pretrained_checkpoint is not None:
        ...
        vla = load_vla(cfg.pretrained_checkpoint, 
                        ...
                        use_ema=cfg.use_ema,
                        view_sequence_len=cfg.view_sequence_len,
                        )

    else:
        vlm = load(cfg.vla.base_vlm, hf_token=hf_token, load_for_training=not cfg.debug, view_sequence_len=cfg.view_sequence_len)
