...
# === CronusVLA-VLA Pretraining Configs ===

@dataclass
class Exp_CronusVLA_OXE_Magic_Soup_Plus_Minus(Exp_SigLIP_224px_Bridge):
...
# === mini (Qwen25) CronusVLA-VLA Pretraining Configs ===
...
class VLARegistry(Enum):
    ...
    # === CronusVLA-VLA Pretraining Configs ===
    EXP_CronusVLA_OXE_MAGIC_SOUP_PLUS_MINUS = Exp_CronusVLA_OXE_Magic_Soup_Plus_Minus
