...
class DinoSigLIPViTBackbone(VisionBackbone):
    ...
    def forward(self, pixel_values: Dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        if self.view_sequence_len == 1:
            ...
            patches = compute_sequence_patches(pixel_values, featurizers, self.view_sequence_len)
    ...
    def num_patches(self) -> int:
        ...
        return self.dino_featurizer.patch_embed.num_patches * self.view_sequence_len
