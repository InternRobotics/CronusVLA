...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 training/train.py \
  --pretrained_checkpoint path/to/openvla-0.5b-prismatic/checkpoints/steps_240000_epoch35.pt \
  ...
  --run_root_dir ./outputs/cronusvla_0_5B_bridge_rt_1 \
  --run_id cronusvla_0_5B_bridge_rt_1 \
  --image_aug True \
