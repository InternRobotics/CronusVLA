...
Usage:
    python experiments/Libero/robot/libero/regenerate_libero_dataset.py \
...
def main(args):
    ...
    metainfo_json_dict = {}
    metainfo_json_out_path = f"./experiments/Libero/robot/libero/{args.libero_task_suite}_metainfo.json"
