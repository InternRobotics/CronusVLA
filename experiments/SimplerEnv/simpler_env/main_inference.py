...
if __name__ == "__main__":
    ...
    assert args.policy_model == "cronusvla"
    if args.policy_model == "rt1":
        ...
        #         action_scale=args.action_scale,
        #     )
    elif args.policy_model == "cronusvla":
        from simpler_env.policies.sim_cronusvla import CronusVLAInference
        assert args.ckpt_path is not None
        model = CronusVLAInference(
            saved_model_path=args.ckpt_path,  # e.g., CronusVLA/CronusVLA-Base
            policy_setup=args.policy_setup,
            action_scale=args.action_scale,
